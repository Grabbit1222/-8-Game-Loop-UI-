...
UDataTable* ASpartaGameState::GetCurrentLevelDataTable() const
{
	if (LevelItemDataTables.IsValidIndex(CurrentLevelIndex))
	{
		return LevelItemDataTables[CurrentLevelIndex];
	}
	return nullptr;
}
